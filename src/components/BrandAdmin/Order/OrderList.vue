          ...
          <div class="col-md-6">
            ...
            <div class="d-flex gap-2 flex-wrap">
              <button
                ...
                :class="{ active: isCurrentRange('today') }"
              >
                今天
              </button>
              <button
                ...
                :class="{ active: isCurrentRange('yesterday') }"
              >
                昨天
              </button>
              <button
                ...
                :class="{ active: isCurrentRange('week') }"
              >
                本週
              </button>
              <button
                ...
                :class="{ active: isCurrentRange('month') }"
              >
                本月
              </button>
            </div>
        ...
        <div class="card shadow-sm">
          <div class="card-body text-center py-4">
            <div class="row align-items-center">
              ...
              <div class="col-md-4">
                <div class="summary-item">
                  <h2 class="text-info mb-1 fw-bold">
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <span class="badge bg-secondary"> 共 {{ pagination.total }} 筆訂單 </span>
        </div>
      </div>
      <div class="card-body">
            ...
            <tbody>
              <tr v-for="order in orders" :key="order._id">
                <td>
                  ...
                  <span v-else
                    >{{ order.orderDateCode }}-{{ String(order.sequence).padStart(3, '0') }}</span
                  >
                </td>
