    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div class="d-flex">
        <div class="input-group" style="width: 300px;">
          <input type="text" class="form-control" placeholder="搜尋折價券..." v-model="searchQuery" @input="handleSearch">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p v-if="couponToToggle">
              您確定要{{ couponToToggle.isActive ? '停用' : '啟用' }}「{{ couponToToggle.name }}」嗎？
            </p>
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p v-if="couponToDelete">
              您確定要刪除折價券「{{ couponToDelete.name }}」嗎？
            </p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
