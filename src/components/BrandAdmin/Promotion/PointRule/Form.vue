      ...
      <form @submit.prevent="submitForm" novalidate>
        ...
        <div class="mb-4">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="ruleName" v-model="formData.name"
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="ruleDescription" v-model="formData.description" rows="3"
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="ruleType" v-model="formData.type" :class="{ 'is-invalid': errors.type }"
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <span class="input-group-text" v-if="formData.type === 'purchase_amount'">每消費 $</span>
              <input type="number" class="form-control" id="conversionRate" v-model="formData.conversionRate" min="1"
                :class="{ 'is-invalid': errors.conversionRate }" required />
              <span class="input-group-text" v-if="formData.type === 'purchase_amount'">= 1 點</span>
              <span class="input-group-text" v-else>點</span>
            </div>
            <div class="invalid-feedback" v-if="errors.conversionRate">{{ errors.conversionRate }}</div>
            <div class="form-text">
          ...
          <div class="mb-3" v-if="formData.type === 'purchase_amount'">
            ...
            <div class="input-group">
              ...
              <input type="number" class="form-control" id="minimumAmount" v-model="formData.minimumAmount" min="0"
                :class="{ 'is-invalid': errors.minimumAmount }" />
            </div>
            <div class="invalid-feedback" v-if="errors.minimumAmount">{{ errors.minimumAmount }}</div>
        ...
        <div class="d-flex justify-content-between">
          ...
          <!-- 右側 - 取消和儲存按鈕 -->
          <div>
            <router-link :to="`/admin/${brandId}/point-rules`" class="btn btn-secondary me-2" :disabled="isSubmitting">
