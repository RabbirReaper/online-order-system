  ...
  >
    ...
    <div class="mb-3">
      ...
      <select v-model="stockType" class="form-select">
        ...
        <option v-if="item.enableAvailableStock && adjustmentType === 'set'" value="both">
          同時設定
        </option>
      </select>
    </div>
    ...
    <div v-if="adjustmentType === 'set'">
      ...
      <div v-if="stockType === 'both'" class="mb-3">
        ...
        <input
          v-model.number="newAvailableStock"
          type="number"
          class="form-control"
          min="0"
          :max="newStock"
      ...
      <div v-if="newStock !== null" class="alert alert-info">
        ...
        <div v-else>
          ...
          <div>
            可販售庫存差異：{{ availableStockDifference }}
