<template>
  <BModal :model-value="show" @update:model-value="emit('close')" title="庫存設定" @ok="submitSettings"
    :ok-disabled="isSubmitting" ok-title="確認變更" cancel-title="取消" no-close-on-backdrop>
    <template #default>
