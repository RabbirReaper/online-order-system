          ...
          <div class="card-body">
            ...
            <div class="mb-4">
              <label class="form-label fw-bold">
                <i class="bi bi-hash me-1"></i>桌號設定
              </label>
              <div class="input-group">
                ...
                <span class="input-group-text">
                  <i class="bi bi-check-circle-fill text-success" v-if="tableConfig.tableNumber"></i>
            ...
            <div class="mb-4" v-if="props.store">
              <div class="alert" :class="props.store.enableLineOrdering ? 'alert-info' : 'alert-warning'">
                <div class="d-flex align-items-center">
                  <i class="bi" :class="props.store.enableLineOrdering ? 'bi-line me-2' : 'bi-globe me-2'"></i>
                  <div>
            ...
            <div class="mb-4">
              <label class="form-label fw-bold">
                <i class="bi bi-palette me-1"></i>樣式設定
              </label>
              <div class="row g-3">
                <div class="col-md-6">
              ...
              <div v-if="showBatchOptions" class="border rounded p-3">
                ...
                <div class="mb-3">
                  ...
                  <div class="form-check">
                    ...
                    >
                    <label class="form-check-label" for="range-mode">
                      數字範圍
                    </label>
                  </div>
                  <div class="form-check">
              ...
              <div v-else class="text-center preview-container">
                ...
                <div class="mt-3">
                  <small class="text-muted">
                    桌號: {{ tableConfig.tableNumber }} | 
                    尺寸: {{ currentSizeInfo.display }} | 
...
// 監聽變化
watch(() => tableConfig.value.tableNumber, () => {
  nextTick(() => updatePreview())
}, { immediate: true })

watch(() => tableConfig.value.size, () => {
  nextTick(() => updatePreview())
})
