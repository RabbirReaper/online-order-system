          ...
          >
            <div class="card">
              ...
              <div class="card-body" v-if="expandedCategories[index]">
                <div class="mb-3">
                  <label :for="`category-name-${index}`" class="form-label required"
                    >分類名稱</label
                  >
                  <input
                    type="text"
...
import { getItemTypeText, getItemTypeBadgeClass, getItemName, sortCategories } from './menuUtils'
