    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between mb-2">
          ...
          <span
            :class="{ 'text-success': selectedOrder.manualAdjustment > 0, 'text-danger': selectedOrder.manualAdjustment < 0 }">
            {{ selectedOrder.manualAdjustment > 0 ? '+' : '' }}${{ Math.abs(selectedOrder.manualAdjustment || 0) }}
          </span>
        </div>
