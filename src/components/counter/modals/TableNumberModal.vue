      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="custom-keypad">
            <div class="row g-2 mb-2">
              <div class="col-4" v-for="char in ['A', 'B', 'C']" :key="char">
                <button class="btn btn-outline-primary w-100" @click="appendToTableNumber(char)">{{ char }}</button>
              </div>
            </div>
            <div class="row g-2 mb-2">
            ...
            <div class="row g-2">
              ...
              <div class="col-4">
                <button class="btn btn-outline-danger w-100" @click="deleteLastChar"> <i class="bi bi-backspace"></i>
                </button>
              </div>
            </div>
          </div>
          ...
          <div class="mt-3">
            ...
            <input type="text" id="manualTableInput" class="form-control" v-model="tableNumber" placeholder="請輸入桌號"
              @keyup.enter="confirmTableNumber">
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" @click="emit('close')">取消</button>
          <button type="button" class="btn btn-primary" @click="confirmTableNumber">
            確認
          </button>
        </div>
      </div>
