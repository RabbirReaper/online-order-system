    ...
    <div class="col-lg-8">
      ...
      <div class="card mb-4">
        <div class="card-header bg-primary text-white">
          <h5 class="mb-0">
            <i class="bi bi-person-gear me-2"></i>基本資訊
          </h5>
        </div>
        <div class="card-body">
          <form @submit.prevent="updateProfile" novalidate>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="username" v-model="profileData.name"
                :class="{ 'is-invalid': profileErrors.name }" required />
            ...
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" id="phone" v-model="profileData.phone"
                :class="{ 'is-invalid': profileErrors.phone }" placeholder="請輸入電話號碼" />
              <div class="invalid-feedback" v-if="profileErrors.phone">{{ profileErrors.phone }}</div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="role" :value="getRoleLabel(profileData.role)" readonly />
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="lastLogin"
                :value="profileData.lastLogin ? formatDate(profileData.lastLogin) : '無記錄'" readonly />
            </div>
            ...
            <div class="alert alert-danger" v-if="profileFormErrors.length > 0">
              <p class="mb-1"><strong><i class="bi bi-exclamation-triangle-fill me-2"></i>發生錯誤：</strong></p>
              <ul class="mb-0 ps-3">
            ...
            <div class="d-flex justify-content-between">
              <button type="button" class="btn btn-secondary" @click="resetProfileForm" :disabled="isProfileSubmitting">
                <i class="bi bi-arrow-counterclockwise me-1"></i>重置
              </button>
              <button type="submit" class="btn btn-primary" :disabled="isProfileSubmitting">
                <span v-if="isProfileSubmitting" class="spinner-border spinner-border-sm me-1" role="status"
      ...
      <div class="card">
        <div class="card-header bg-warning text-dark">
          <h5 class="mb-0">
            <i class="bi bi-shield-lock me-2"></i>修改密碼
          </h5>
        </div>
        <div class="card-body">
          <form @submit.prevent="changePassword" novalidate>
            ...
            <div class="mb-3">
              ...
              <div class="invalid-feedback" v-if="passwordErrors.currentPassword">{{ passwordErrors.currentPassword }}
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="invalid-feedback" v-if="passwordErrors.confirmPassword">{{ passwordErrors.confirmPassword }}
              </div>
            </div>
            ...
            <div class="mb-3" v-if="passwordData.newPassword">
              ...
              <div class="progress" style="height: 8px;">
                <div class="progress-bar" :class="passwordStrengthClass"
                  :style="{ width: passwordStrengthPercentage + '%' }" role="progressbar"></div>
              </div>
              <small class="form-text" :class="passwordStrengthTextClass">{{ passwordStrengthText }}</small>
            </div>
            ...
            <div class="d-flex justify-content-between">
              ...
              <button type="submit" class="btn btn-warning" :disabled="isPasswordSubmitting">
                <span v-if="isPasswordSubmitting" class="spinner-border spinner-border-sm me-1" role="status"
                  aria-hidden="true"></span>
