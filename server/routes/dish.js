...
// 創建選項類別（系統級和品牌級）
router.post(
  '/brands/:brandId/option-categories',
  authenticate('admin'),
  requireRole('primary_system_admin', 'system_admin', 'primary_brand_admin', 'brand_admin'),
  requireBrandAccess,
...
// 更新選項類別（系統級和品牌級）
router.put(
  '/brands/:brandId/option-categories/:id',
  authenticate('admin'),
  requireRole('primary_system_admin', 'system_admin', 'primary_brand_admin', 'brand_admin'),
  requireBrandAccess,
