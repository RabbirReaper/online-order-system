...
8. (PAC) 訂單 API 整合測試 - 完成 (14 tests, Failed Tests 5 )
...
4. 庫存統計服務測試
5. 外送平台服務測試（UberEats 整合）
6. 店鋪管理服務測試
7. 菜單服務測試
8. 客戶端狀態測試（customerAuth, menu）
9. POS 系統狀態測試（counter stores）
10. 控制器測試
11. 認證流程整合測試

### 低優先級 (P3)

1. 菜品相關服務測試（dishInstance, optionService 等）
